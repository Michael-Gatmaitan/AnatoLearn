...
public class RespiratoryViewedTagClickManager : MonoBehaviour
{
    private Camera cam;

    [Header("Assign your viewed tags here")]
    public GameObject viewedTagNasalCavity;
    public GameObject viewedTagPharynx;
    public GameObject viewedTagLarynx;
    public GameObject viewedTagTrachea;
    public GameObject viewedTagBronchi;
    public GameObject viewedTagLungs;
    ...
    void Start()
    {
        ...
        {
            { "nasal_CavityDescriptionCon", viewedTagNasalCavity },
            { "pharynxDescriptionCon", viewedTagPharynx },
            { "larynxDescriptionCon", viewedTagLarynx },
            { "tracheaDescriptionCon", viewedTagTrachea },
