...
public class NervousViewedTagClickManager : MonoBehaviour
{
    private Camera cam;

    [Header("Assign your viewed tags here")]
    public GameObject viewedTagCerebrum;
    public GameObject viewedTagHypothalamus;
    public GameObject viewedTagMedulaOblongata;

    public GameObject viewedTagBrainStem;
    public GameObject viewedTagCerebellum;
    ...
    void Start()
    {
        ...
        {
            { "cerebrumDescriptionCon", viewedTagCerebrum },
            { "hypothalamusDescriptionCon", viewedTagHypothalamus },
            { "medulla_OblongataDescriptionCon", viewedTagMedulaOblongata },
            { "brain_StemDescriptionCon", viewedTagBrainStem },
            { "cerebellumDescriptionCon", viewedTagCerebellum },
        };
    ...
    void DetectHit(Ray ray)
    {
        ...
        if (Physics.Raycast(ray, out RaycastHit hit))
        {
            ...
            {
                if (labelToViewedTag.TryGetValue(label.labelID, out GameObject objTag))
                {
                    if (objTag != null)
                    {
                        objTag.SetActive(true);
