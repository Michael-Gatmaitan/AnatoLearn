...
public class NeuronsCardCarousel : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        cardsContainer = root.Q<VisualElement>("neuronsCardsCon");
        ...
        foreach (var card in cardsContainer.Children())
        {
            ...
            var prevBtn = card.Q<Button>("neuronPrevBtn");
            var nextBtn = card.Q<Button>("neuronNextBtn");
