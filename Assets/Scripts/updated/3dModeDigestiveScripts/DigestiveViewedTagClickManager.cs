...
public class DigestiveSkeletalViewedTagClickManager : MonoBehaviour
{
    private Camera cam;

    [Header("Assign your viewed tags here")]
    public GameObject viewedTagMouth;
    public GameObject viewedTagEsophagus;
    public GameObject viewedTagStomach;
    public GameObject viewedTagSmallIntestine;
    public GameObject viewedTagRectum;
    public GameObject viewedTagLargeIntestine;
    ...
    void Start()
    {
        ...
        {
            { "mouthDescriptionCon", viewedTagMouth },
            { "esophagusDescriptionCon", viewedTagEsophagus },
            { "stomachDescriptionCon", viewedTagStomach },
            { "small_IntestineDescriptionCon", viewedTagSmallIntestine },
            { "rectumDescriptionCon", viewedTagRectum },
            { "large_IntestineDescriptionCon", viewedTagLargeIntestine },
        };
