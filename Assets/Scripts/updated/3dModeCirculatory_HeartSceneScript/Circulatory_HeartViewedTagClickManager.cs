...
public class Circulatory_HeartViewedTagClickManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            { "right_AtriumDescriptionCon", viewedTagRightAtrium },
            { "tricuspid_ValveDescriptionCon", viewedTagTricuspidValve },
            { "right_VentricleDescriptionCon", viewedTagRightVentricle },
            { "inferior_Vena_CavaDescriptionCon", viewedTagInferiorVenaCava },
            { "superior_Vena_CavaDescriptionCon", viewedTagSuperiorVenaCava },
            { "pulmonary_ValveDescriptionCon", viewedTagPulmonaryValve },
            { "pulmonary_ArteryDescriptionCon", viewedTagPulmonaryArtery },
            { "aortic_ValveDescriptionCon", viewedTagAorticValve },
            { "pulmonary_VeinDescriptionCon", viewedTagPulmonaryVein },
            { "left_VentricleDescriptionCon", viewedTagLeftVentricle },
            { "left_AtriumDescriptionCon", viewedTagLeftAtrium },
            { "mitral_ValveDescriptionCon", viewedTagMitralValve },
        };
                    ...
                    if (r.data.Count >= 1)
                    {
                        foreach (var data in r.data)
                        {
                            ...
                            else
                            {
                                ...
                                Debug.Log("Buildket from heart: " + labelToViewedTag[buildKey]);
    ...
    {
        Debug.Log("Tag to activate: " + labelID);
        ...
        {
            Debug.Log("Cannot find tag to activate");
        }
    }
