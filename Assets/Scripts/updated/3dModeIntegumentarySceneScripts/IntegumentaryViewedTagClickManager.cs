...
public class IntegumentaryViewedTagClickManager : MonoBehaviour
{
    private Camera cam;

    [Header("Assign your viewed tags here")]
    public GameObject viewedTagHairShaft;
    public GameObject viewedTagHairRoot;
    public GameObject viewedTagSweatGland;
    public GameObject viewedTagHypodermis;
    public GameObject viewedTagPoreOfGland;
    public GameObject viewedTagEpidermis;
    public GameObject viewedTagDermis;
    ...
    {
        cam = Camera.main;
        // tagClickManager = FindObjectOfType<TagClickManager>(); //903
        tagClickManager = FindFirstObjectByType<TagClickManager>(); //903

        // Initialize dictionary
        labelToViewedTag = new Dictionary<string, GameObject>
        {
            { "hair_ShaftDescriptionCon", viewedTagHairShaft },
            { "hair_RootDescriptionCon", viewedTagHairRoot },
            { "sweat_GlandDescriptionCon", viewedTagSweatGland },
            { "hypodermisDescriptionCon", viewedTagHypodermis },
            { "pore_Of_GlandDescriptionCon", viewedTagPoreOfGland },
            { "epidermisDescriptionCon", viewedTagEpidermis },
            { "dermisDescriptionCon", viewedTagDermis },
        };
