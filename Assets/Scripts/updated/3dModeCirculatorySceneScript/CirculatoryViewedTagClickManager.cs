...
public class CirculatoryViewedTagClickManager : MonoBehaviour
{
    private Camera cam;

    [Header("Assign your viewed tags here")]
    public GameObject viewedTagCapillaries;
    public GameObject viewedTagHeart;
    public GameObject viewedTagArteries;
    public GameObject viewedTagVeins;
    ...
    void Start()
    {
        ...
        {
            { "capillariesDescriptionCon", viewedTagCapillaries },
            { "heartDescriptionCon", viewedTagHeart },
            { "arteriesDescriptionCon", viewedTagArteries },
            { "veinsDescriptionCon", viewedTagVeins },
            { "blood_VesselsDescriptionCon", viewedTagBloodVessels },
        };
